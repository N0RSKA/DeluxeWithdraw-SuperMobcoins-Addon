...
import dev.norska.dwaddon.smc.update.UpdateChecker;
...
public class UpdateHandler {
	...
	public void checkForUpdates(SMCAddon main) {
	...
	public void sendUpdateMessage(SMCAddon main, CommandSender cms, Boolean join) {
		if (updateAvailable) {
				cms.sendMessage("");
